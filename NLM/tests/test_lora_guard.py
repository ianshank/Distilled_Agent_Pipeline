...
class TestLoRASetup:
    ...
    def test_setup_with_auto_detection(self):
        ...
        lora_model = setup_lora_adapter(
            model, rank=8, alpha=16, dropout=0.1, target_modules=None  # Auto-detect
        )
    ...
    def test_setup_with_explicit_targets(self):
        ...
        lora_model = setup_lora_adapter(
            model, rank=8, alpha=16, dropout=0.1, target_modules=["c_attn", "c_proj"]
        )
    ...
    def test_invalid_targets_fallback(self):
        ...
        lora_model = setup_lora_adapter(
            model, rank=8, alpha=16, target_modules=["nonexistent_module", "fake_layer"]
        )
