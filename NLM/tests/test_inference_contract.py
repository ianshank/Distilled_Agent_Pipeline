...
class TestInferenceRequest:
    ...
    def test_valid_request(self):
        ...
        request = InferenceRequest(prompt="Test prompt", max_length=256, temperature=0.8)
...
class TestFlaskEndpoints:
    ...
    def test_invocations_valid_request(self, mock_inference_server, mock_model_dir):
        ...
        request_data = {"prompt": "Test prompt", "max_length": 128, "temperature": 0.7}

        response = client.post(
            "/invocations", data=json.dumps(request_data), content_type="application/json"
        )
    ...
    def test_invocations_invalid_content_type(self, mock_inference_server, mock_model_dir):
        ...
        response = client.post("/invocations", data="not json", content_type="text/plain")
